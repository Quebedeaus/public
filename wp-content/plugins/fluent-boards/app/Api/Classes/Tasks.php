...
class Tasks
{
    ...
    public function createTaskAttachment(int $boardId, int $taskId, array $data = [])
    {
        ...
        if (!defined('FLUENT_BOARDS_PRO_VERSION') || !PermissionManager::userHasPermission($boardId) || empty($data) || empty($data['url'])) {
            return false;
        }
    ...
    public function deleteTaskAttachment( int $boardId, int $taskId, int $attachmentId)
    {
        ...
        if (!defined('FLUENT_BOARDS_PRO_VERSION') || !PermissionManager::userHasPermission($boardId)) {
            return false;
        }
