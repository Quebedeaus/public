...
// Rejoin the lines, adding back the new line character
    ...
    public function update($commentData, $comment_id, $mentionData)
    {
        ...
        if(!$comment->parent_id) {
            do_action('fluent_boards/comment_updated', $comment->task_id, $oldComment, $comment->settings['raw_description']);
        }
    ...
    public function delete($comment_id)
    {
        ...
        do_action('fluent_boards/comment_deleted', $taskId, $commentDescription);
    }
