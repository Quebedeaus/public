...
$app->addCustomAction('comment_updated', 'ActivityHandler@logCommentUpdateActivity', 10, 3);
$app->addCustomAction('comment_deleted', 'ActivityHandler@logCommentDeleteActivity', 10, 2);
